...
resource openai 'Microsoft.CognitiveServices/accounts@2024-10-01' = {
  ...
  kind: 'OpenAI'
  properties: {
    customSubDomainName: 'cm000000000000000'
...
resource openai_cm000000000000000_chat 'Microsoft.CognitiveServices/accounts/deployments@2024-06-01-preview' = {
  name: 'cm000000000000000_chat'
  properties: {
    model: {
      format: 'OpenAI'
      name: 'gpt-35-turbo'
...
resource openai_cm000000000000000_embedding 'Microsoft.CognitiveServices/accounts/deployments@2024-06-01-preview' = {
  name: 'cm000000000000000_embedding'
  properties: {
    model: {
      format: 'OpenAI'
